...
namespace Lilium.ToonGraph.Editor
{
    ...
    sealed class ToonTarget : Target
    {
        ...
        {
            const string kForwardPass = "Assets/lgu3d/Shader/Toon/Editor/ShaderGraph/ToonForwardPass.hlsl";
            const string kOutlinePass = "Assets/lgu3d/Shader/Toon/Editor/ShaderGraph/ToonOutlinePass.hlsl";
