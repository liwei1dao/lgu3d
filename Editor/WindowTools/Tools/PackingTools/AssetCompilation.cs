...
namespace lgu3d.Editor
{
    public class AssetCompilation : BaseTools<PackingTools>
    {
        ...
        private void RightView()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            Parent.Config.ProVersion = EditorGUILayout.IntField("大版本号:", Parent.Config.ProVersion);
            Parent.Config.ResVersion = EditorGUILayout.IntField("小版本号:", Parent.Config.ResVersion);
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
