...
namespace lgu3d
{
  ...
  {
    void ShowSplashAd(string aId);
    void ShowBannerAd(string aId);
    void HideBannerAd();
    void ShowInterstitialAd(string aId);
    void ShowRewardAd(string aId, Action<bool> backcall);
  }

  public class PangolinAdvModule : ManagerContorBase<PangolinAdvModule>, IAppDownloadListener, IAdv
  {
    ...
    public void ShowExpressSplashAdComp(string advId)
    {
    ...
    {
      expressBannerAdComp.HideAdv();
    }
    public void ShowRewardAd(string advId, Action<bool> callback)
    {
      expressRewardAdComp.ShowAdv(advId, callback);
    }
