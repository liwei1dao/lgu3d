...
public final class UnionApplication extends Application {
  ...
  public void onCreate() {
    ...
    TTAdConfig config = new TTAdConfig.Builder().appId("5152058").useTextureView(false) // 使用TextureView控件播放视频,默认为SurfaceView,当有SurfaceView冲突的场景，可以使用TextureView
        .appName("旋风陀螺").titleBarTheme(TTAdConstant.TITLE_BAR_THEME_DARK).allowShowNotify(true) // 是否允许sdk展示通知栏提示
