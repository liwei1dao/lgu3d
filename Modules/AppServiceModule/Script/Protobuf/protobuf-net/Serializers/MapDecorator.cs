...
namespace ProtoBuf.Serializers
{
    class MapDecorator<TDictionary, TKey, TValue> : ProtoDecoratorBase where TDictionary : class, IDictionary<TKey, TValue>
    {
        ...
        public static void CreateInvalidInstanceForAot<TDictionary, TKey, TValue>() where TDictionary : class, IDictionary<TKey, TValue>
        {
            _ = new MapDecorator<TDictionary, TKey, TValue>(null, null, null, null, 0, WireType.None, WireType.None, WireType.None, false);
        }
                  ...
                  : (IProtoSerializer)new DefaultValueDecorator(model, DefaultValue, new TagDecorator(2, valueWireType, false, valueTail)))
        {
            ...
            UnityEngine.Debug.Log("MapDecorator 构造");
