        ...
        private IProtoSerializer BuildSerializer()
        {
            ...
            try
            {
                ...
                if (IsMap)
                {
                    ...
                    // ser =  (IProtoSerializer)PType.CreateInstance(typeof(MapDecorator<,,>).MakeGenericType(new Type[] { dictionaryType, keyType, valueType }),
                    //     new object[] {model, concreteType, keySer, valueSer, fieldNumber,
                    //         DataFormat == DataFormat.Group ? WireType.StartGroup : WireType.String, keyWireType, valueWireType, OverwriteList });

                    UnityEngine.Debug.Log("开始创建 MapDecorator");
