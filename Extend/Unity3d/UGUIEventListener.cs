...
namespace lgu3d
{
    ...
    ISubmitHandler, ICancelHandler
    {
        ...
        public UGUIEventListener.VectorDelegate onDragStart;
        public UGUIEventListener.VectorDelegate onDrag;
        public UGUIEventListener.UGUIEventObjectDelegate onDragOver;
        public UGUIEventListener.UGUIEventObjectDelegate onDragOut;
        public UGUIEventListener.UGUIEventObjectDelegate onDragEnd;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            if (onDragStart != null)
            {
                if (!IsForbid())
                {
                    onDragStart(eventData, gameObject, eventData.delta, getEventArgs());
                }
                else if (IsAllowedMe(gameObject))
                {
                    onDragStart(eventData, gameObject, eventData.delta, getEventArgs());
